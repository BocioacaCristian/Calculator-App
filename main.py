...
root = tk.Tk()
root.geometry("300x275")     # <----- This creates the window

text_result = tk.Text(root, height = 2, width = 16, font = ("Arial", 24))   #<--------- Creeaza cum v-a arata textul
text_result.grid(columnspan = 5)                # Creeaza locul pentru text
